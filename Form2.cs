...
namespace Harapan_Sehat
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            using (var dataCommand = new MySqlCommand("SELECT * FROM daftar_pasien", this.con))
        ...
        private void load_single_pasien(int patient_id)
        {
            ...
            if (dataReader.HasRows == true)
            {
                ...
                textBox5.Text = dataReader.GetString(dataReader.GetOrdinal("birth_place"));
                ...
                textBox4.Text = dataReader.GetString(dataReader.GetOrdinal("occupation"));
            }
            else
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            var tmp_lahir = textBox5.Text;
            var pekerjaan = textBox4.Text;
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //dimulai dari baris di bawah, komponen pada dataGridView1 dipindahkan kekomponen baru yaitu DataTable pada variabel dt
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    //membuka save file dialog untuk menentukan tempat penyimpananfile
